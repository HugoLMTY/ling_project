...
//     // oled.setCursor(maxPos[1] - (message.length() * fontSizes[textSize]), maxPos[0] - (navbarHeight - navbarOffset)); // Was before string truncate, wip still unsure
//     oled.setCursor((maxPos[1] / 2) + 1, maxPos[0] - (navbarHeight - navbarOffset));
//   }
//   else
//   if (type == "status") {
//     // Starts from the start (LEFT)
//     oled.setCursor(0, maxPos[0] - (navbarHeight - navbarOffset));
